...
public:
  ...
  // NOTE: Above type signatures cannot verify full type info of source message. Linker can fail if user makes mistakes.
  // NOTE: Serialized messages currently unsupported.
